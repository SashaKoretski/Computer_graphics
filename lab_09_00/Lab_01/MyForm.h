...
namespace Lab01 {
	...
	private: bool if_closed1 = false;
	private: bool if_closed2 = false;
	private: myPoint^ beg_point = gcnew myPoint(0, 0);
	private: myPoint^ beg_point2 = gcnew myPoint(0, 0);
...
private: System::Windows::Forms::TextBox^ textBox_x_otr;

private: System::Windows::Forms::Label^ label_y_otr;
private: System::Windows::Forms::Label^ label_x_otr;





private: System::Windows::Forms::TextBox^ textBox_y_otr;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox_x_otr = (gcnew System::Windows::Forms::TextBox());
			this->label_y_otr = (gcnew System::Windows::Forms::Label());
			this->label_x_otr = (gcnew System::Windows::Forms::Label());
			this->textBox_y_otr = (gcnew System::Windows::Forms::TextBox());
			...
			this->label_title->Text = L"Лабораторная по компьютерной графике №9";
			// 
			// btn_collapce
			// 
			...
			this->label_add->Size = System::Drawing::Size(111, 24);
			this->label_add->TabIndex = 5;
			this->label_add->Text = L"Отсекатель";
			// 
			// button_add
			// 
			...
			this->label_color_choose->Font = (gcnew System::Drawing::Font(L"Trebuchet MS", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label_color_choose->Location = System::Drawing::Point(988, 408);
			...
			this->button_ots_color->Font = (gcnew System::Drawing::Font(L"Trebuchet MS", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button_ots_color->Location = System::Drawing::Point(992, 435);
			this->button_ots_color->Name = L"button_ots_color";
			this->button_ots_color->Size = System::Drawing::Size(154, 29);
			...
			// textBox_x_otr
			// 
			this->textBox_x_otr->Location = System::Drawing::Point(1009, 281);
			this->textBox_x_otr->Name = L"textBox_x_otr";
			this->textBox_x_otr->Size = System::Drawing::Size(52, 20);
			this->textBox_x_otr->TabIndex = 64;
			// 
			// label_y_otr
			// 
			this->label_y_otr->AutoSize = true;
			this->label_y_otr->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(231)), static_cast<System::Int32>(static_cast<System::Byte>(253)),
				static_cast<System::Int32>(static_cast<System::Byte>(254)));
			this->label_y_otr->Location = System::Drawing::Point(989, 310);
			this->label_y_otr->Name = L"label_y_otr";
			this->label_y_otr->Size = System::Drawing::Size(14, 13);
			this->label_y_otr->TabIndex = 63;
			this->label_y_otr->Text = L"Y";
			// 
			// label_x_otr
			// 
			this->label_x_otr->AutoSize = true;
			this->label_x_otr->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(231)), static_cast<System::Int32>(static_cast<System::Byte>(253)),
				static_cast<System::Int32>(static_cast<System::Byte>(254)));
			this->label_x_otr->Location = System::Drawing::Point(989, 284);
			this->label_x_otr->Name = L"label_x_otr";
			this->label_x_otr->Size = System::Drawing::Size(14, 13);
			this->label_x_otr->TabIndex = 62;
			this->label_x_otr->Text = L"X";
			// 
			// textBox_y_otr
			// 
			this->textBox_y_otr->Location = System::Drawing::Point(1009, 307);
			this->textBox_y_otr->Name = L"textBox_y_otr";
			this->textBox_y_otr->Size = System::Drawing::Size(52, 20);
			this->textBox_y_otr->TabIndex = 61;
			// 
			// button_add_otr
			// 
			...
			this->button_add_otr->Click += gcnew System::EventHandler(this, &MyForm::button_add_Click2);
			// 
			// label_add_otr
			// 
			...
			this->label_add_otr->Size = System::Drawing::Size(143, 24);
			this->label_add_otr->TabIndex = 59;
			this->label_add_otr->Text = L"Многоугольник";
			// 
			// button_res_color
			// 
			this->button_res_color->Font = (gcnew System::Drawing::Font(L"Trebuchet MS", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button_res_color->Location = System::Drawing::Point(992, 505);
			this->button_res_color->Name = L"button_res_color";
			this->button_res_color->Size = System::Drawing::Size(154, 29);
			...
			this->button_otr_color->Font = (gcnew System::Drawing::Font(L"Trebuchet MS", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button_otr_color->Location = System::Drawing::Point(992, 470);
			this->button_otr_color->Name = L"button_otr_color";
			this->button_otr_color->Size = System::Drawing::Size(154, 29);
			this->button_otr_color->TabIndex = 70;
			this->button_otr_color->Text = L"Цвет многоугольника";
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Trebuchet MS", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button1->Location = System::Drawing::Point(992, 374);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(143, 35);
			this->button1->TabIndex = 71;
			this->button1->Text = L"Замкнуть";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &MyForm::button_close_2_Click);
			// 
			// MyForm
			// 
			...
			this->Controls->Add(this->textBox_x_otr);
			this->Controls->Add(this->label_y_otr);
			this->Controls->Add(this->label_x_otr);
			this->Controls->Add(this->textBox_y_otr);
...
#pragma endregion
	...
	private: System::Void инструкцияToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
		MessageBox::Show("Добро пожаловать!\n\n"
			...
			"\tЧтобы добавить многоугольник для отсекания, необходимо ввести его координаты на экране, либо нажатиями на экране после замыкания отсекателя.\n"
			"\nОтсекание:\n\n"
			"\tЧтобы отсечь многоугольник, необходимо сначала замкнуть фигуру, проверить что она выпукла, затем нажать на кнопку \"Отсечь\" на экране либо в меню.\n"
			"\nУдаление:\n\n"
	...
	private: System::Void условиеЗадачиToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
		MessageBox::Show("Фигура задается координатами ее точек. Необходимо реализовать алгоритм"
			"отсекания многоугольника произвольным отсекателем.",
			"Условие задачи №9");
	}
	...
	private: System::Void draw_Line2(myPoint^ newPoint) {
		if (if_closed2 == true) {
			otr->Add(newPoint);
			beg_point2 = newPoint;
		}
		else if (otr->Count >= 1)
			drawOts2(newPoint, otr[otr->Count - 1]);
		else {
			otr->Add(newPoint);
			beg_point2 = newPoint;
		}
	...
	private: System::Void button_add_Click2(System::Object^ sender, System::EventArgs^ e) {
		double x_add = 0;
		double y_add = 0;

		if (Double::TryParse(textBox_x_otr->Text, x_add) && Double::TryParse(textBox_y_otr->Text, y_add)) {
			myPoint^ newPoint = gcnew myPoint(x_add, y_add);

			textBox_x_otr->Text = "";
			textBox_y_otr->Text = "";

			draw_Line2(modifyPoint(newPoint));
		}
		else {
			textBox_x_otr->Text = "";
			textBox_y_otr->Text = "";
	...
	private: void drawOts2(myPoint^ beg, myPoint^ end) {
		Pen^ myPen = gcnew Pen(otrColor);
		Graphics^ g = surface->CreateGraphics();
	...
	private: System::Void button_close_2_Click(System::Object^ sender, System::EventArgs^ e) {
		if_closed2 = true;
		if (otr->Count >= 2) {
			drawOts2(beg_point2, otr[otr->Count - 1]);
			otr->RemoveAt(otr->Count - 1);
		}
	}
	...
	// Проверяем, находится ли точка справа от ребра
	bool IsInside(myPoint^ p, myPoint^ p1, myPoint^ p2) {
		return (p2->X - p1->X) * (p->Y - p1->Y) - (p2->Y - p1->Y) * (p->X - p1->X) < 0;
	}

	// Находим точку пересечения двух рёбер
	myPoint^ Intersection(myPoint^ cp1, myPoint^ cp2, myPoint^ s, myPoint^ e) {
		double A1 = cp2->Y - cp1->Y;
		double B1 = cp1->X - cp2->X;
		double C1 = A1 * cp1->X + B1 * cp1->Y;

		double A2 = e->Y - s->Y;
		double B2 = s->X - e->X;
		double C2 = A2 * s->X + B2 * s->Y;

		double delta = A1 * B2 - A2 * B1;
		if (delta == 0) {
			throw gcnew System::Exception("Lines do not intersect");
		}

		double x = (B2 * C1 - B1 * C2) / delta;
		double y = (A1 * C2 - A2 * C1) / delta;
		return gcnew myPoint(x, y);
	}

		   // отсечение
	private: void cut() {
		List<myPoint^>^ inputList = otr;
		for (int i = 0; i < points->Count; i++) {
			int len = inputList->Count;
			myPoint^ cp1 = points[i];
			myPoint^ cp2 = points[(i + 1) % points->Count];

			List<myPoint^>^ outputList = gcnew List<myPoint^>();
			for (int j = 0; j < len; j++) {
				myPoint^ s = inputList[j];
				myPoint^ e = inputList[(j + 1) % len];
				if (IsInside(e, cp1, cp2)) {
					if (!IsInside(s, cp1, cp2)) {
						outputList->Add(Intersection(cp1, cp2, s, e));
					}
					outputList->Add(e);
				}
		...
		for (int i = 0; i < result->Count; i++) {
			first = result[i];
			second = result[(i + 1) % result->Count];
